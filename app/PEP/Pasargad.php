...
use App\myappenv;
use  App\PEP\Classes\AbstractPayment;
use  App\PEP\Classes\PaymentItem;
use  App\PEP\Classes\PaymentType;
use  App\PEP\Classes\RequestBuilder;
use  App\PEP\Classes\RSA\RSAProcessor;
...
class Pasargad extends AbstractPayment
{
    ...
    {
        $this->merchantId = myappenv::PEPMerchantCode;
        $this->terminalId = myappenv::PEPTerminalCode;
        $this->redirectUrl = route('ConfirmPayment', ['pay' => 'pep','ref'=>null]);
        $this->certificate = myappenv::PEPPrivate;

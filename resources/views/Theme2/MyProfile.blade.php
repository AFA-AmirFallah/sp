    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    <h5 class="card-header gradient-purple-indigo 0-hidden pb-80">جزئیات پروفایل</h5>
                    <!-- Account -->
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            @if (Auth::user()->avatar == null)
                                <img src="{{ App\myappenv::LoginUserAvatarPic }}" alt="user-avatar" class="d-block rounded"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control text-start" dir="ltr" type="text" id="email"
                                        name="email" value="{{Auth::user()->Email}}" placeholder="john.doe@example.com">
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="phoneNumber" name="phoneNumber"
                                            class="form-control text-start" dir="ltr" value="{{Auth::user()->MobileNo}}" placeholder="202 555 0111">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                ...
                <div class="card">
                    <h5 class="card-header gradient-purple-indigo 0-hidden pb-80">حذف حساب</h5>
                    <div class="card-body">

                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" required name="NameFa" id="NameFa"
                                        onkeyup="ChangeName()" placeholder="نام فارسی آزمون" value="">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-right-icon">
                                        <input type="text" class="form-control" name="NameEn" required
                                            placeholder="Enter Good English name" value="">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-right-icon">
                                        <input type="number" class="form-control" name="BasePrice" value="0">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-sm-12 row  input-right-icon">
                                        <div class="col-sm-3">
                                            ...
                                            <textarea id="variables" name="variables" rows="10" class=" form-control"></textarea>

                                        </div>
                                        <div class="col-sm-3">
                                            <label for="notes" class="ul-form__label">توضیح متغییر</label>
                                            <textarea id="notes" name="notes" rows="10" class=" form-control"></textarea>

                                        </div>
                                        <div class="col-sm-3">
                                            <label for="defaultval" class="ul-form__label">مقدار اولیه</label>
                                            <textarea id="defaultval" name="defaultval" rows="10" class=" form-control"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <button type="submit" class="btn btn-primary m-1" name="submit"
                                                value="addexam">ثبت آزمون </button>

...
@section('MainCountent')
    ...
    @include('hiring/objects/stepers_comments', ['target_step' => 1, 'id' => $id])
    <div class="row">
            ...
            <div class="card o-hidden mb-4">
                <div class="card-header gradient-purple-indigo 0-hidden pb-80">
                    <h3 id="Table-card-header" class="text-white  w-50 float-left card-title m-0"><i
                            class=" header-icon i-Receipt"></i> اطلاعات پایه </h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group ">
                                            <label> نام و نام خانوادگی درمانگر / پرستار :<span class="reqired">*</span>
                                            </label>
                                            <input class=" form-control " required name="Name"
                                                value="{{ $comment_src['Name'] }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" required name="service"
                                                value="{{ $comment_src['service'] }}" placeholder="وصل سرم" type="text">
                                            <div class="invalid-feedback">نام خدمت ارائه شده می باید وارد گردد.</div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>شماره موبایل درمانگر / پرستار:<span class="reqired">*</span></label>
                                            <input class="form-control" required inputmode="numeric"
                                                value="{{ $comment_src['MobileNo'] }}" id="MobileNo"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>کد پرستار بانک درمانگر / پرستار:<span class="reqired">*</span></label>
                                            <input class="form-control" required inputmode="numeric"
                                                value="{{ $comment_src['code'] }}" id="MobileNo" placeholder="09122233203"
                                                type="text">
                                            <div class="invalid-feedback">شماره موبایل یا کد پرستار بانک می باید وارد
                                                شود</div>
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="center_name"
                                                value="{{ $comment_src['center_name'] }}" placeholder="مرکز پرستاری امید "
                                                type="text">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea style="height:200px;" class="form-control " name="comment" placeholder="متن گزارش"> {{ $comment_src['comment'] }}</textarea>
                                            <div class="invalid-feedback">متن گزارش می باید وارد شود!</div>
                                            <small>تجربه شخصی یا مشاهدات خود را<a class="site-button-link"
                                                    href="javascript:void(0);">اینجا </a>بنویسید.</small>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div style="margin-right: 10px;">
                                                <div>
                                                    <input type="radio" class="index_1"

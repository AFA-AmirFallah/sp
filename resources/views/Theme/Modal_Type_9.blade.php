                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <div class="input-group">
                            ...
                            <input id="modal_pic_1" class="form-control" type="text" required name="pic1"
                                value="">
                            <input class="form-control" type="text" id="modal_link_1" name="link1" required
                                value="" placeholder="متن HTML">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="modal_active" name="staus"
...
<script>
    $input_counter = 2;
    function addrow() {
        $("#extrafileds").append(`<div class="input-group">
                            <span class="input-group-btn">
                                <a id="lfm_` + $input_counter + `" data-input="modal_pic_` + $input_counter + `" data-preview="holder"
                                    class="btn btn-primary text-white">
                                    <i class="fa fa-picture-o"></i> انتخاب تصویر
                                </a>
                            </span>
                            <input id="modal_pic_` + $input_counter + `" class="form-control" type="text" required
                                name="pic` + $input_counter + `" value="">
                            <input class="form-control" type="text" id="modal_link_` + $input_counter +
            `" name="link` + $input_counter + `"

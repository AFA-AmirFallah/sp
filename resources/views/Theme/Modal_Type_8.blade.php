                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <div class="input-group">
                            ...
                            <label for="inputName" class="col-sm-2 col-form-label"> متن نمایش
                            </label>
                                <input  class="form-control" id="modal_Limit_1" required name="subtitle1"
                                    value="">
                        ...
                        <div class="input-group">
                            ...
                            <label for="inputName" class="col-sm-2 col-form-label"> متن نمایش
                                ...
                                <input  class="form-control" id="modal_Limit_2" required name="subtitle2"
                                    value="">
                        </div>
                        <div class="input-group">
                            ...
                            <label for="inputName" class="col-sm-2 col-form-label"> متن نمایش
                                ...
                                <input  class="form-control" id="modal_Limit_3" required name="subtitle3"
                                    value="">
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <label for="inputName" class="col-sm-2 col-form-label"> تیتر نمایش
                                ...
                                <input class="form-control" id="modal_title_3" required name="title4"
                                    placeholder="متن نمایش">

                            <label for="inputName" class="col-sm-2 col-form-label"> متن نمایش
                            </label>
                                <input  class="form-control" id="modal_Limit_3" required name="subtitle4"
                                    value="">
                        </div>

            ...
            <div class="col-sm-12">
                <div class="card tab2-card">
                    <div class="card-header gradient-purple-indigo 0-hidden pb-80">
                        <h5 class="text-white">تبلغ هدر</h5>
                    </div>
                    <div class="card-body">
                        <div>
                            <img src="{{ asset('Theme5/manual/headerads.png') }}" alt="slaider">
                        </div>
                    </div>
                    <code>
                        ...
                        &lt;div class="ads-header-wrapper"&gt;
                            &lt;a href="#" class="ads-header hidden-sm" target="_blank"
                                style="background-image: url(/Theme5/assets/img/banner/large-ads.jpg)"&gt;&lt;/a&gt;
                        &lt;/div&gt;

                    </code>
                    <div class="card-footer">
                        <a href="{{ route('HtmlObj', ['Cat' => 'Theme5_header_ads']) }}" class="btn btn-primary">ویرایش</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card tab2-card">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('HtmlObj', ['Cat' => 'Theme1_RightMenu']) }}"

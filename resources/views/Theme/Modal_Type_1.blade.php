                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" id="modal_text_1" name="text1"
                                            required value="" placeholder="متن">
                                    </td>
                                    <td>
                                        <input class="form-control" type="text" id="modal_color_1" name="color1"
                                            required value="" placeholder="رنگ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" id="modal_text_2" name="text2"
                                            required value="" placeholder="متن">
                                    </td>
                                    <td>
                                        <input class="form-control" type="text" id="modal_color_2" name="color2"
                                            required value="" placeholder="رنگ">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" id="modal_text_3" name="text3"
                                            required value="" placeholder="متن">
                                    </td>
                                    <td>
                                        <input class="form-control" type="text" id="modal_color_3" name="color3"
                                            required value="" placeholder="رنگ">
                                    </td>
                                </tr>
...
<script>
    function EditModal($selectID) {
        ...
        $('#editeelement').show();
        $('#DeleteElement').show();
        Pic1 = $('#pic1_' + $selectID).val();
        Pic2 = $('#pic2_' + $selectID).val();
        Pic3 = $('#pic3_' + $selectID).val();

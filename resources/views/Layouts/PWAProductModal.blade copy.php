                       ...
                       <div class="modal-dialog modalPWA">
                           <div class="modal-content">
                               <div class="modal-header">
                                   <img src="{{ \App\myappenv::FavIcon }}" style="width: 25px" alt="{{ \App\myappenv::CenterName }}_logo">
                               ...
                               <div class="modal-body">
                                   <form method="post">
                                       ...
                                       <div class="form-group row">
                                           <img id='modal_product_img' src="" alt="ProductImg">
                                       </div>
                                       <h6 id="Modal_product_name" class="CustomerServiceCardHeader m-0"></h6>

                                       <h5 id="Modal_product_price" style="padding-top: 30px;"
                                           class="CustomerServiceCardHeader m-0"></h5>
                                       <del id="Modal_product_base_price" class="text-secondary"></del>
                                       <div id="Attrebute"></div>
                                       <div id='index_table_loader' style="text-align: center">
                                       ...
                                       <hr>
                                       <div class="buyform form-group row">
                                       ...
                                       <h6 class="buyform" id="totoall_div"></h6>
                                       <br>
                                       <h6 class="buyform" id="totall_benefit"></h6>
                                       <button id="AddToBasketbtn" onclick="AddToBasket()" type="button"
                                           class="buyform btn btn-block btn-primary m-1" name="submit" value="">افرودن
                                           به
                                           سبد خرید
                                       </button>
                                       <div id="finishproduct">
                                           <h6>تمام شده! </h6>
                                           <p>محصول مورد نظر تمام شده است. </p>
                                           <div id="customertextaria" class="form-group">
                                               <label>توضیحات مشتری</label>
                                               <textarea class="form-control" id="alertnote" rows="3"></textarea>
                                           </div>

                                           <button id="alertbtn" onclick="alertme()" type="button"
                                               @if (!Auth::check()) disabled @endif class="btn btn-block btn-primary m-1"
                                               name="submit" value="">
                                               در صورت موجود شدن به من خبر بده!
                                           </button>
                                           @if (!Auth::check()) <small>جهت ثبت می باید به سیستم وارد شوید!</small>  @endif
                                       </div>

...
@section('MainContent')
    ...
    <div class="page-content become-a-vendor">
        <div class="container create-store pb-1 pb-lg-10 mb-10">
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <figure class="br-sm">
                        <img src="https://panel.shafatel.com/storage/photos/landing/marketplace/marketplace.jpg"
                            alt="Banner" width="610" height="435" style="background-color: #D9D8DD;" />
                    </figure>
                </div>
                <div class="col-md-6 order-md-first">
                    <h4 class="text-primary font-weight-bold ls-25">ایجاد فروشگاه </h4>
                    <h2 class="title text-left">پیوستن به زنجیره تامین سلامت شفاتل</h2>
                    <p>
                        شفاتل فراهم آورنده بستر همکاری فعالان حوزه سلامت در یک بستر فناورانه است تا بتوانیم با استفاده از
                        قابلیت های تمامی فعالان این حوزه خدمات شایسه را به بیماران ارائه دهیم و با کمک همدیگر از رنجهای
                        بیماران بکاهیم.
                    </p>
                    <p>
                        شاید تجربه طراحی سایت و قدم نهادن در دنیای اینترنت را داشته باشید. ما مطمئن هستیم این کار برای شما
                        هزینه های زیادی در پی داشته است و نتیجه مطلوبی از این تجربه کسب نکرده اید.

                        ما با تیم فناوری اطلاعات حرفه ای خود تا رسیدن به بزرگترین دستاوردها همراه شما
                        هستیم.امروز می‌تواند شروعی برای موفقیت آنلاین شما باشد.فروشگاه آنلاین خود را با بیشترین امکانات و در
                        سریع‌ترین زمان ممکن راه‌اندازی کنید و با دیگر همکاران خود در این حوزه همکاری لذت بخشی مبتنی بر عدالت
                        تجربه کنید.
            ...
            <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <figure class="br-sm">
                            <img src="https://panel.shafatel.com/storage/photos/landing/Joinus/joinus.jpg" alt="Banner" width="610"
                    ...
                    <div class="col-lg-6 pl-lg-8">
                        ...
                        <h2 class="title text-left">مراحل فروش کالا و خدمات در شفاتل</h2>
                        <p class="mb-6">هر محصولی یا خدمتی می‌تواند ویژگی‌ها و قیمت‌های متفاوت داشته باشد. مشتری شما هم
                            می‌تواند به
                            کمک دسته‌بندی، فیلترینگ و جستجو، کالا یا خدمات مورد نظرش را پیدا کند</p>
                        <div class="row cols-sm-2 mb-1">
                            <div class="stage-item mb-6 stage-register d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">ثبت نام کنید و کالا یا خدمات خود را ثبت کنید </p>
                            </div>
                            <div class="stage-item mb-6 stage-selling d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">شروع به فروش کالا یا خدمت رسانی کنید </p>
                            </div>
                            <div class="stage-item mb-5 stage-deliver d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">کالا یا خدمات خود را ارائه دهید</p>
                            </div>
        ...
        <div class="container few-fees mt-10 mb-2 mb-lg-10 pt-2 pt-lg-9">
            <h4 class="text-center text-primary text-capitalize font-weight-bold ls-25">مزایای همکاری با شفاتل</h4>
            <h2 class="title title-center mb-3">همه چیز ایمن و شفاف است</h2>
            <div class="row">
                <div class="col-sm-6 listing-fee">
                    <div class="counter text-center">

                        <h4>درگاه پرداخت خود شما</h4>
                        <p>مبلغ کالا یا خدمات شما به درگاه شخصی شما واریز میگردد</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 final-fee">
                    <div class="counter text-center">
                        ...
                        <h4>بازاریابی و افزایش مشتری
                        </h4>
                        <p>شفاتل با استفاده از سیستم های هوشمند بیماران را بر اساس نیاز به کسب و کار شما هدایت می کند.</p>
                    </div>
        ...
        <div class="container questions mt-2 mt-lg-10 mb-5 mb-lg-9">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h4 class="font-weight-bold ls-25">کارمزد شفاتل به چه صورت است؟</h4>
                    <p> در صورتی که بیمار از طریق مرکز وارد شده باشد کارمزد ۰.۱٪ از مبلغ فروش کالا یا خدمت می باشد و در
                        صورتی که بیمار از مرکز دیگری ارجاع شده باشد حد اقل کارمزد ۶ درصد از مبلغ ارايه کالا یا خدمت است.</p>
                    <h4 class="font-weight-bold ls-25"> امکان استفاده از سامانه شفاتل برای کسب و کار من وجود دارد</h4>
                    <p>در صورت نیاز به استفاده از سامانه شفاتل به صورت اختصاصی برای مجموعه خود کافی است با ما در ارتباط
                        باشید تا مراحل کار را با شما در میان بگذاریم.</p>
                </div>
                <div class="col-md-6">
                    <h4 class="font-weight-bold ls-25">در صورتی که بیمار خود را به مراکز دیگر ارجاع دهم چه مبلغی کارمزد به
                        من تعلق می گیرد </h4>
                    <p>در صورتی که بیماری که در مرکز شما وارد سامانه شفاتل شده باشد خریدی از سایر همکاران شفاتل انجام دهد به
                        صورت متوسط ۵ درصد از مبلغ خرید سهم شما خواهد بود.</p>
                    <h4 class="font-weight-bold ls-25">تسویه حساب شفاتل با مراکز چگونه است؟</h4>
                    <p>
                        با توجه به اینکه سیاست ما در شفاتل این است که خود وارد تبادلات مالی نشویم تسویه حساب ارجاع و کیف پول
                        حد اکثر ۴۸ ساعت بعد از ثبت درخواست می باشد.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
                ...
                <div class="container">
                    <div class="banner-content text-center">
                        <h2 class="title title-center text-white font-weight-bold">همین الان همکار شفاتل شوید</h2>
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <input required oninvalid="this.setCustomValidity('Enter User Name Here')"
                                    ...
                                    class="form-control form-control-md" name="StoreName"
                                    placeholder="نام فروشگاه - مرکز خود را به فارسی وارد کنید">
                                ...
                                <select required class="form-control form-control-md" aria-label="Default select example"
                                    ...
                                    <option value="هوم کر">هوم کر</option>
                                    <option value="فروشنده کالای سلامت"> فرشنده کالای سلامت</option>
                                    <option value="اجاره"> اجاره دهنده تجهیزات پزشکی</option>
                                    <option value="پیشگیری"> کسب و کار پیشگیری محور</option>
                                    <option value="خدمات دهنده">خدمات دهنده عمومی</option>
                            ...
                            <div>
                                <label>کدپستی: </label>
                                <input required type="niumber" class="form-control form-control-md"
                                    name="ُStorePostalCode" placeholder="">
                            </div>
                            <div>
                                <label>آدرس: </label>
                                <small>توجه کنید که ارتباط با شما (از جمله بازگشت محصول)، فقط از طریق این آدرس خواهد بود.
                                </small>
                                <textarea required type="text" id="" cols="80" rows="10" class="form-control form-control-md"
                                    name="StoreAddress"></textarea>

                            </div>
                            <div class="form-group mb-10">
                                <label>درباره فروشگاه:</label>
                                <textarea required type="text" id="" cols="80" rows="10"
                                    class="form-control form-control-md10" name="Storeaboutus"></textarea>

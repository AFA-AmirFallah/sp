...
@section('MainContent')
    ...
    <div class="page-content become-a-vendor">
        <div class="container create-store pb-1 pb-lg-10 mb-10">
            <div class="row align-items-center">
                <div class="col-md-6 mb-4 mb-md-0">
                    <figure class="br-sm">
                        <img src="https://kookbaz.ir/assets/images/landing.png" alt="Banner" width="610" height="435"
                            style="background-color: #D9D8DD;" />
                    </figure>
                </div>
                <div class="col-md-6 order-md-first">
                    <h4 class="text-primary font-weight-bold ls-25">ایجاد فروشگاه </h4>
                    <h2 class="title text-left">فروشگاه آنلاین خود را در کوکباز بسازید</h2>
                    <p>

                        .از اولین قدم‌هایی که به دنیای اینترنت می‌گذارید، تا رسیدن به بزرگترین دستاوردها همراه شما
                        هستیم.امروز می‌تواند شروعی برای موفقیت آنلاین شما باشد.فروشگاه آنلاین خود را با بیشترین امکانات و در
                        سریع‌ترین زمان ممکن راه‌اندازی کنید. همین امروز، فروشگاهتان را بسازید و محصولات خود را به آنها عرضه
                        کنید.
                    </p>
            ...
            <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        <figure class="br-sm">
                            <img src="https://kookbaz.ir/assets/images/infoghraphy.jpg" alt="Banner" width="610"
                                height="520" style="background-color: #C9C8CD;" />
                        </figure>
                    </div>
                    <div class="col-lg-6 pl-lg-8">
                        <h4 class="text-primary font-weight-bold ls-25">نحوه فروش </h4>
                        <h2 class="title text-left">مراحل فروش محصول در کوکباز</h2>
                        <p class="mb-6">هر محصولی می‌تواند ویژگی‌ها و قیمت‌های متفاوت داشته باشد. مشتری شما هم می‌تواند به
                            کمک دسته‌بندی، فیلترینگ و جستجو، محصول مورد نظرش را پیدا کند</p>
                        <div class="row cols-sm-2 mb-1">
                            <div class="stage-item mb-6 stage-register d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">ثبت نام کنید و محصولات خود را لیست کنید </p>
                            </div>
                            <div class="stage-item mb-6 stage-selling d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">شروع به فروش محصولات خود کنید </p>
                            </div>
                            <div class="stage-item mb-5 stage-deliver d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">محصولات خود را به همه جا تحویل دهید</p>
                            </div>
                            <div class="stage-item mb-5 stage-get d-flex align-items-center">
                                ...
                                <p class="mb-0 font-weight-bold">پرداخت کنید و درآمد خود را افزایش دهید</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container few-fees mt-10 mb-2 mb-lg-10 pt-2 pt-lg-9">
            <h4 class="text-center text-primary text-capitalize font-weight-bold ls-25">مزایای غرفه سازی</h4>
            <h2 class="title title-center mb-3">همه چیز ایمن و شفاف است</h2>
            <div class="row">
                <div class="col-sm-6 listing-fee">
                    <div class="counter text-center">

                        <h4>درگاه پرداخت امن</h4>
                        <p> ﺑﺪون ﻧﯿﺎز ﺑﻪ دردﺳﺮﻫﺎی اداری، ﺻﺎﺣﺐ درﮔﺎه اﻣﻦ ﺑﺎﻧﮑﯽ ﭘﺮداﺧﺖ ﺷﻮﯾ</p>
                    </div>
                </div>
                ...
                <div class="col-sm-6 final-fee">
                    <div class="counter text-center">
                        ...
                        <h4>شفافیت مالی</h4>
                        <p>ﺑﺪون ﻧﯿﺎز ﺑﻪ ﺣﺴﺎﺑﺪار، در ﺟﺮﯾﺎن ﮔﺮدش ﻣﺎﻟﯽ ﮐﺴﺐ‌وﮐﺎر ﺧﻮد ﺑﺎﺷﯿﺪ.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-6 listing-fee">
                    <div class="counter text-center">
                        ...
                        <h4>ﺧﺪﻣﺎت مشتری‌ها</h4>
                        <p> ﭘﺸﺘﯿﺒﺎﻧﯽ مشتری‌هایتان ﺑﺮ ﻋﻬﺪه ﻣﺎست؛ وﻗﺖ‌ ﺧﻮد را ﺻﺮف ﮐﺴﺐ‌و‌ﮐﺎرﺗﺎن ﮐﻨﯿﺪ.</p>
                    </div>
                </div>
                ...
                <div class="col-sm-6 final-fee">
                    <div class="counter text-center">
                        ...
                        <p>در کوکباز، ﻓﻨﻮن و روش‌ﻫﺎی ﮐﺴﺐ‌وﮐﺎر اﯾﻨﺘﺮﻧﺘﯽ را ﺑﺪون ﻫﺰﯾﻨﻪ ﯾﺎد ﺑﮕﯿﺮﯾﺪ.</p>
                    </div>
                  ...
                  {{--   <div class="container mt-0 mt-lg-10 mb-2 mb-lg-9">
                        <div class="row">
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                <h4 class="text-primary font-weight-bold ls-25">آنها چه می گویند</h4>
                                <h2 class="title text-left ls-25">داستانهای موفقیت از فروشندگان وولمارت</h2>
                                ...
                                <a href="vendor-dokan-store.html" class="btn btn-dark btn-link btn-underline btn-icon-right">
                                    نمایش فروشندگان<i class="w-icon-long-arrow-left"></i></a>
                            </div>
                            <!-- End of Col -->
                            <div class="col-lg-8">
                                <div class="owl-carousel owl-theme row cols-sm-2" data-owl-options="{
                                    ...
                                    <div class="testimonial-wrap">
                                        <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                            ...
                                            <cite class="ls-25">
                                                ویکتوریا ونتورا <span>سرمایه گذار </span>
                                            </cite>
                                        </div>
                                    </div>
                                    <div class="testimonial-wrap">
                                        <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                            ...
                                            <cite class="ls-25">
                                                جعفر عباسی <span>سرمایه گذار </span>
                                            </cite>
                                        </div>
                                    </div>
                                    <div class="testimonial-wrap">
                                        <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                            ...
                                            <cite class="ls-25">
                                                آنا واردی <span>سرمایه گذار </span>
                                            </cite>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container questions mt-2 mt-lg-10 mb-5 mb-lg-9">
            <h4 class="text-center text-primary font-weight-bold text-capitalize ls-25">سوالات متداول</h4>
            <h2 class="title title-center">پاسخ سوالات خود را بیابید</h2>
            <div class="row">
                <div class="col-md-6">
                    <h4 class="font-weight-bold ls-25">کارمزد کوکباز به چه صورت است؟</h4>
                    <p> کارمزد کوکباز از هر تراکنش موفق نصف سود شما از فروش محصول است </p>
                    <h4 class="font-weight-bold ls-25">برای ارسال سفارش چه کاری باید انجام دهم؟</h4>
                    <p>سفارش را تولید و بسته‌بندی کرده و از طریق پست ارسال کنید</p>
                </div>
                <div class="col-md-6">
                    <h4 class="font-weight-bold ls-25">هزینه‌های ارسال سفارش با چه کسی است؟
                    </h4>
                    <p>مشتری هنگام خرید از غرفه هزینه ارسال را نیز پرداخت می‌کند،</p>
                    <h4 class="font-weight-bold ls-25">تسویه حساب کوکباز با غرفه‌دارها چگونه است؟</h4>
                    <p>
                        تسویه حساب دو شرط دارد: ۱- مراحل سفارش تا انتها توسط غرفه‌دار ثبت شده باشد - ۲- رضایت مشتری روی
                        سفارش ثبت شده باشد در این صورت حداکثر 5 روز کاری بعد از درخواست شما، کوکباز با شما تسویه می‌کند.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}"
                ...
                <div class="container">
                    <div class="banner-content text-center">
                        <h2 class="title title-center text-white font-weight-bold">همین الان غرفه خود بسازید</h2>
                    ...
                    <div style="background-color: #fafafa;">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                <input required   oninvalid="this.setCustomValidity('Enter User Name Here')"
                                oninput="this.setCustomValidity('')" type="text" class="form-control form-control-md" name="StoreName"
                                    placeholder="نام فروشگاه خود را به فارسی وارد کنید">

                                <label> نوع کسب و کار:</label>

                                <select required class="form-control form-control-md" aria-label="Default select example"
                                    name="Business-Type">
                            ...
                            <div>
                                <label>کدپستی: </label>
                                <input required type="niumber" class="form-control form-control-md" name="ُStorePostalCode"
                                    placeholder="">
                            </div>
                            <div>
                                <label>آدرس: </label>
                                <small>توجه کنید که ارتباط با شما (از جمله بازگشت محصول)، فقط از طریق این آدرس خواهد بود.
                                 ...
                                 <textarea required type="text" id="" cols="80" rows="10" class="form-control form-control-md" name="StoreAddress"></textarea>
                               
                            </div>
                            <div class="form-group mb-10">
                                <label>درباره فروشگاه:</label>
                                <textarea required  type="text" id="" cols="80" rows="10" class="form-control form-control-md10" name="Storeaboutus"></textarea>

                                ...
                                @if ($ContInBasket > 0)
                                    <div class="dt-sl mt-4">
                                        <button type="button" class="btn-primary-cm btn-with-icon">
                                            <img src="/Theme5/assets/img/theme/shopping-cart.png" alt="">
                                            موجود در سبد خرید
                                        </button>
                                    </div>
                                @else
                                            ...
                                            <div class="product-variant dt-sl">
                                                ...
                                                <ul class="product-variants float-right ml-3">
                                                    @foreach ($unit_plan as $unit_plan_item)
                                                        <li onclick="set_unit({{ $unit_plan_item->multiple }})"
                                                            class="ui-variant">
                                                    ...
                                                    @endforeach
                                                    <li onclick="set_unit({{ $ProductTarget->Unit ?? 1 }})"
                                                        class="ui-variant">
                                                        <label style="direction: rtl"
                                                            class="ui-variant ui-variant--color">
                                    ...
                                    @else
                                        @if (Auth::check())
                                            ...
                                            @endphp
                                            <a id="product_alert"
                                                href="javascript:add_product_alert({{ $TargetGood->id }})"
                                            ...
                                            <div class="@if (!$alerted) d-none @endif"
                                                id="product_alerted"

...
<body>
    ...
    <div class="wrapper">
                            ...
                            <div class="search-area dt-sl">
                                <form id="main_search_form" action="/search" method="get" style="max-height: 30px"
                                    ...
                                    <button class="close-search-result" onclick="celar_search()" type="button"><i
                                            style="font-size: 24px;position: absolute;margin-top: -17px;margin-right: -12px;"
                        ...
                        <div class="col-12 mb-3">
                            <div class="widget-search">
                                <input type="text" name="q"
                                    placeholder="نام کالا یا برند مورد نظر را جستجو کنید">
        ...
        <footer class="main-footer dt-sl">
                ...
                <div class="container main-container">
                    <div class="row">
                        <div class="footer_items col-12 col-lg-3">
                            <ul class="list-group">
                                ...
                                <ul id="about_sec_list" class="list-group d-none sub_menue_cus">
                                    <a target="_blank"
                                        href="https://sepehrmall.com/news/6/%D8%AF%D8%B1%D8%A8%D8%A7%D8%B1%D9%87%20%D8%B3%D9%BE%D9%87%D8%B1%20%D9%85%D8%A7%D9%84">
                        ...
                        <div class="footer_items site-description col-12 col-lg-7">
                            <h4 class="site-title">فروشگاه اینترنتی سپهرمال</h4>
                            <p style="text-align: right">
                                فروشگاه اینترنتی سپهرمال فعالیت خود را از سال ۱۳۹۸ به عنوان تامین کننده مواد غذایی خارجی
                                و محصولات بهداشتی خارجی آغاز کرده است . هدف اصلی فروشگاه اینترنتی سپهرمال ارائه محصولات
                                اصل خارجی با بهترین قیمت و بیشترین تاریخ مصرف است و نهایتا رضایت مشتری است . ما در
                                فروشگاه اینترنتی سپهرمال هدف خود را ارائه بهترین محصولات به مشتریان محترم قرارداده ایم
                        ...
                        <div style="margin-top: -8px" class="footer_items symbol col-12 col-lg-2">
                            <a href="https://trustseal.enamad.ir/?id=165551&amp;Code=cfiJIMiNkgcF4gxAlllc"
                                ...
                                target="_blank"><img src="/Theme5/assets/img/symbol-02.png" alt="اینماد"></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="copyright">
                <div class="container main-container">
                    <p>
                        استفاده از مطالب فروشگاه اینترنتی سپهرمال فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است.
                        کلیه حقوق این سایت متعلق
                        (فروشگاه آنلاین سپهرمال) می‌باشد.
                    </p>
                </div>
            </div>
        </footer>
    ...
    @endif
    <script type="text/javascript" src="https://s1.mediaad.org/serve/106761/retargeting.js"async></script>
    <script>
        ! function(t, e, n) {
            ...
            s.id = "ua-script-T2oZed1d";
            s.dataset.analyticsobject = n;
            s.async = 1;
            s.type = "text/javascript";
            s.src = "https://cdn.yektanet.com/rg_woebegone/scripts_v3/T2oZed1d/rg.complete.js?v=" + r, c.parentNode
                .insertBefore(s, c)

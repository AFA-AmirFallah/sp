        ...
        <div class="row mb-3">
            ...
            <div class="col-12">
                <div class=" section-title text-sm-title  ">
                    <h2>{{ $mobile_banner->title }}</h2>
                    <a target="_blank" href="{{ route('ShowProduct', ['Tags' => App\Functions\Themes::get_value_from_Json($mobile_banner->pic, 'TagUID')]) }}"
                        type="button"
                        ...
                        @if ($loop->first)
                            <div class="item">
                                <div class="amazing-product text-center pt-5">
                                    <a target="_blank"
                                        href="{{ route('ShowProduct', ['Tags' => App\Functions\Themes::get_value_from_Json($mobile_banner->pic, 'TagUID')]) }}">
                                        <img src="{{ App\Functions\Themes::get_value_from_Json($mobile_banner->pic, 'pic2') }}" alt="{{ $mobile_banner->title }}">
                                    </a>
                                    <a target="_blank" href="{{ route('ShowProduct', ['Tags' => App\Functions\Themes::get_value_from_Json($mobile_banner->pic, 'TagUID')]) }}"
                        ...
                        <div class="item">
                            <div class="product-card mb-3">
                                <div class="product-head">
                                    ...
                                    <div style="margin-top: -3px;margin-right: -20px" class="product-head">
                                        ...
                                        <div class="steps_icon  rating-stars">
                                            ...
                                            @else
                                                <div class="no_steps" style="height: 22px"></div>
                                            @endif
                                        </div>
                                ...
                                <div class="product-card-body">
                                    ...
                                    @if ($steps)
                                    <span
                                    class="product-price">از {{ number_format($Price / App\Http\Controllers\Credit\currency::GetCurrencyRate()) }}
                                ...
                                @endif
                                        ...
                                        <div   class="add-to-card fast-buy-div-new">
                                            <button type="button" role="button"  
                                                ...
                                                data-target="#product_fast_show" class="btn btn-primary p-2 rounded-circle fast-buy-btn-new"><i
                                                    
                                                    class="mdi mdi-cart-plus fast-buy-i-new"></i></button>
                                        </div>
                                    @if ($management)
                                        <a role="button" href="{{ route('EditProduct', ['id' => $ProductItem->id]) }}"
                                            direction="right" font-size="1.4" height="3"><i

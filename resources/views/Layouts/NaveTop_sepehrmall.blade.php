...
<div class="horizontal-bar-wrap">
    <div class="header-topnav">
        <div class="container-fluid">
            <div class="topnav rtl-ps-none ps ps--active-y" id="" data-perfect-scrollbar=""
                data-suppress-scroll-x="true">
                <ul style="display: inline-flex" class="menu float-right">
                    <li class="">
                        <div>
                            <div>
                                <a href="{{route('home')}}">
                ...
                <div class="ps__rail-y" style="top: 0px; height: 48px; right: 0px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 4px;"></div>
                </div>
            </div>
        </div>
    </div>

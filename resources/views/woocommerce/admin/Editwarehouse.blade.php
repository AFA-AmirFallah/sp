...
@section('MainCountent')
    ...
    <form method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control" required id="Name" name="Name" value="{{$warehouse->Name}}"
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" @if($warehouse->status == 0) checked @endif
                               id="modal_active"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" @if($warehouse->status == 1) checked @endif
                               id="modal_deactive"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required class="form-control" id="Postalcode"
                           name="Postalcode" value="{{$warehouse->Postalcode}}"
        ...
        <div class="form-group row">
            <div class="col-sm-10">
                <button id="addelement" type="submit" name="submit" value="addwarehouse"
                        class="btn btn-success">ثبت تغییرات
                </button>

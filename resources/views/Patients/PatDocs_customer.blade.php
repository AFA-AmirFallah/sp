                    ...
                    <div class="card-header gradient-purple-indigo 0-hidden pb-80">
                        <h5 class="text-white"><i class=" header-icon i-Folder-Archive"></i>پرونده الکترونیک:
                            ...
                            <div class="dropdown dropleft text-right w-50 float-right">
                                <button  style="
                                margin-top: -53px;
                            " onclick="window.open('{{ url('/') . '/filemanager?type=file&usertraget=' . $UserInfoResult->UserName }}',
                                    'newwindow',
                                    'width=1000,height=600');
                         return false;" class="btn btn-primary" type="button" id="dropdownMenuButton_table_1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <tbody>
                                        @foreach ($ParvandehMains as $ParvandehMain)
                                            <tr>
                                                ...
                                                @if (Auth::user()->Role == \App\myappenv::role_SuperAdmin)
                                                    <th>{{ $ParvandehMain->creatorName }}
                                                        {{ $ParvandehMain->creatorFamily }} </th>
                                                @endif
                                                <th>

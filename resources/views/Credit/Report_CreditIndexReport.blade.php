                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <button type="submit" class="btn btn-default" name="submit"
                                    value="DaramadGraph">{{__("Show graph")}}</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-10">
                    <div class="card-body">
                        <div
                            class="card-title">{{__("Benefit")}} {{__("from Date:")}} {{ $Persian->MyPersianDate($StartDate) }} {{__("to Date:")}} {{$Persian->MyPersianDate($EndDate)}}
                            <a href="{{route('DaramadReport')}}">{{__("Back")}}</a></div>
...
@section('page-js')
    ...
    $maxfeild = 0;
                    ...
                    yAxis: {
                        ...
                        axisLine: {lineStyle: {color: "#ccc", width: 1}},
                        axisTick: {lineStyle: {color: "#ccc", width: 1}},
                        splitLine: {lineStyle: {color: "#ddd", width: 1, opacity: .5}}
                    },
                    series: [{
                        name: "درآمد",
                        type: "line",
                        ...
                        symbolSize: 8,
                        showSymbol: !1,
                        lineStyle: {color: "rgb(255, 87, 33)", opacity: 1, width: 1.5},
                        itemStyle: {show: !1, color: "#ff5721", borderColor: "#ff5721", borderWidth: 1.5},
                        areaStyle: {
                            normal: {
                                color: {
                                    type: "linear",
                                    ...
                                    x2: 0,
                                    y2: 1,
                                    colorStops: [{offset: 0, color: "rgba(255, 87, 33, 1)"}, {
                                        offset: .3,

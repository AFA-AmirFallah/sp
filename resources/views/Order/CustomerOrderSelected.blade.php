...
@section('MainCountent')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div id="register_section" class="main-content" >
                ...
                <section class="row contact-section">
                    <div class="col-lg-6 mb-8">
                        ...
                        <form class="form contact-us-form" method="post">
                            ...
                            <a type="button" href="{{route('CustomerOrder')}}" class="btn btn-warning btn-rounded">
                                بازگشت</a>
                            <button type="submit" style="display: inline-flex;" class="btn btn-dark btn-rounded"> ثبت
                                درخواست  <div id="center_title" style="margin-right: 3px;margin-left: 3px"> </div>
                            </button>
                        </form>
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="card ul-card__border-radius">
                                            ...
                                            <div id="accordion-item-noicon-3" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    پس از ثبت درخواست در پلتفرم بیمارستان‌مجازی - درخواست ثبت شده مستقیما به مرکز
                                                    خدمات
                                        ...
                                        <div class="card ul-card__border-radius">
                                            ...
                                            <div id="accordion-item-noicon-5" class="collapse"
                                                data-parent="#accordionExample">
                                                <div class="card-body">
                                                    با توجه به اینکه پلتفرم بیمارستان‌مجازی در روال مالی فی مابین ارائه دهندگان
                                                    خدمات یا
                                                    ...
                                                    کارشناسان
                                                    بیمارستان‌مجازی این فرایند را برای شده تسهیل خواهند نمود.

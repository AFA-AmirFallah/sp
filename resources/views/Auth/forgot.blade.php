                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-4">
                            ...
                            <h1 class="mb-3 text-18 " style="text-align: center;">{{ __('Recover password') }}</h1>
                            <form method="post">
                                @csrf
                                ...
                                @if (\App\myappenv::Captcha == 'google')
                                  <!--   <button type="submit" data-sitekey=""
                                        data-callback='onSubmit'
                                        class="btn btn-rounded btn-primary btn-block mt-2 g-recaptcha"></button> !-->
                                    <button type="submit"  class="btn btn-rounded btn-primary btn-block mt-2 ">{{ __('Send password with SMS') }}</button>
                                @else
                                    <button type="submit"
                                        class="btn btn-rounded btn-primary btn-block mt-2">{{ __('Send password with SMS') }}</button>
                                @endif
                            ...
                            <div class="mt-3 text-center">
                                <a href="{{ Route('forgot') }}"
                                    class="text-muted"><u>{{ __('Enter to login panel') }}
                                    </u>
                                </a>
                            </div>
                        </div>

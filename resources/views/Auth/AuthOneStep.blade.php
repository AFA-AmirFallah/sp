    ...
    @php
        ...
        if (!isset($UserInfo->UserName)) {
            ...
            if ($branch_src == null) {
                ...
                $BrancSrc['branch_name'] = $branch_src->Name ;
                $BrancSrc['branch_avatar'] = $branch_src->avatar ;
            }
        } else {
                                ...
                                <div>
                                    ...
                                    <form method="post">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group form-group-rtl">
                                                <label>{{ __('Name') }}</label>
                                                <input id="input_name" name="Name" autocomplete="off" value="{{old('Name') ?? ''}}" required
                                                    onkeyup="cehckinput()" class="form-control form-control-rounded"
                                                    type="text">
                                            </div>
                                            <div class="form-group form-group-rtl">
                                                <label>{{ __('Family') }}</label>
                                                <input id="input_family" name="Family" value="{{old('Family') ?? ''}}" required autocomplete="off"
                                                    onkeyup="cehckinput()" class="form-control form-control-rounded"
                                                    type="text">
                                            </div>
                                            @if (isset($Feilds->melliid))
                                                <div class="form-group form-group-rtl">
                                                    ...
                                                    @if (isset($Feilds->melliid_req))
                                                        <input id="MelliID" name="MelliID" value="{{old('MelliID') ?? ''}}" required
                                                            autocomplete="off"

...
@section('MainCountent')
        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-3">
                    <div class="card card-icon mb-4">
                        <div class="card-header text-center blue text-white font-weight-bold ">
                            <i class="i-Myspace text-white mt-1" style="font-size: 30px"></i>
                            گروه ها
                        </div>
                        <div class="card-body text-center">
                            <div class="btnaria-header" style="display: flex">
                                <a href="{{ route('auto_admin', ['page' => 'group_add']) }}"
                                    class="btn btn-danger btn-block m-1 mb-3">افرودن <i class=" text-white"></i></a>
                                <a href="{{ route('auto_admin', ['page' => 'group_list']) }}"
                                    class="btn btn-primary btn-block m-1 mb-3">فهرست <i class=" text-white"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-3">
                    <div class="card card-icon mb-4">
                        <div class="card-header text-center blue text-white font-weight-bold ">
                            <i class="i-Tag text-white mt-1" style="font-size: 30px"></i>
                            برچسب های
                        </div>
                        <div class="card-body text-center">
                            <div class="btnaria-header" style="display: flex">
                                <a href="{{ route('auto_admin', ['page' => 'tag_add']) }}"
                                    class="btn btn-danger btn-block m-1 mb-3">افرودن <i class=" text-white"></i></a>
                                <a href="{{ route('auto_admin', ['page' => 'tag_list']) }}"
                                    class="btn btn-primary btn-block m-1 mb-3">فهرست <i class=" text-white"></i></a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        @switch($page)
            @case('group_list')
                @include('Auto.SubView.group_list')
            @break

            @case('group_add')
                @include('Auto.SubView.group_add')
            @break
            @case('tag_add')
                @include('Auto.SubView.tag_add')
            @break
            @case('tag_list')
                @include('Auto.SubView.tag_list')
            @break

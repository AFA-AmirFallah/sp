                ...
                <div class="card text-left">
                    <div class="card-header text-right bg-transparent">
                        <button id="addobject" type="button" data-toggle="modal" data-target=".bd-example-modal-lg"
                            class="btn btn-primary btn-md m-1"> تصویر بزرگ اضافه کنید
                        </button>
                    </div>
                    <!-- begin::modal -->
                    <div class="ul-card-list__modal">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">تیتر / متن </label>
                                                <div class="col-sm-10">
                                    ...
                                    @foreach ($elements as $element)
                                        <tr id="tr_{{ $element->id }}">
                                            ...
                                            <td id="pic_{{ $element->id }}" name="{{ $element->pic }}"><img
                                                    src="{{ $element->pic }}" style="width: 108px;"/></td>
                                            <td class="d-none" id="link_{{ $element->id }}" name="{{ $element->link }}">
                                                {{ $element->link }}</td>
                                            <td id="status_{{ $element->id }}" @if ($element->status == '1')
                                                name="{{ $element->status }}">✅
                                            </td>
                                        @else
                                            name="{{ $element->status }}">❌</td>
                                    @endif

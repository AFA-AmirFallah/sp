            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="page-header-left">
                        <h3>تم ساز
                            <small><a href="{{ route('ThemeMaker') }}">مدیریت المانهای تم</a> </small>
                        </h3>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="col-sm-12">
                <div class="card tab2-card">
                    <div class="card-header gradient-purple-indigo 0-hidden pb-80">
                        <h5>محتوای المان</h5>
                        <img id="imagepreviw" style="float: left;max-height: 100px;" src="{{ $BannerSrc->pic }}">
                    </div>
                    <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade active show" id="account" role="tabpanel"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <select name="UserRole" class="form-control col-xl-3 col-md-3">
                                            ...
                                            @foreach ($UserLevel as $UserLevelItem)
                                                <option value="{{ $UserLevelItem->Role }}" @if ($BannerSrc->Role == $UserLevelItem->Role) selected="selected" @endif>
                                        ...
                                        <select name="ContentAccessLevel" class="form-control col-xl-3 col-md-3">
                                            ...
                                            @foreach (app\myappenv::Themes as $Themes)
                                                <option value="{{ $Themes[0] }} @if ($BannerSrc->MainTheme == $Themes[0]) selected="selected" @endif
                                                ">{{ $Themes[1] }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="number" id="modal_order" name="order" value="{{ $BannerSrc->order }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="number" name="theme" value="{{ $BannerSrc->theme }}" required
                                                placeholder="کد تم">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="number" id="modal_page" name="Page" required value="{{ $BannerSrc->page }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" id="modal_link" name="link" required
                                                value="{{ $BannerSrc->link }}" placeholder="آدرس">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="modal_title" required name="title" value="{{ $BannerSrc->title }}"
                                                placeholder="تایتل">
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="modal_active"
                                                        name="staus" id="gridRadios1" value="1" @if($BannerSrc->status == 1)  checked @endif >
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="modal_deactive"
                                                        name="staus" id="gridRadios2" value="0"  @if($BannerSrc->status == 0)  checked @endif >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input required id="modal_pic" class="form-control nested" required type="text"
                                            name="pic" value="{{ $BannerSrc->pic }}" onchange="imagesetter()">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <textarea required id="hiddenArea" required name="ce"
                                    class="col-sm-12 form-control">{{ $BannerSrc->content }} </textarea>

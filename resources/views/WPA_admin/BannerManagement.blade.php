...
@section('MainCountent')
    ...
    <div class="ul-card-list__modal">
        <div class="modal fade SelectBanner" tabindex="-1" role="dialog"
                            ...
                            <table id="ul-contact-list" class="display table " style="width:100%">
                                ...
                                @foreach($elements as $element)
                                    <tr id="tr_{{$element->id}}">
                                        ...
                                        <td id="order_{{$element->id}}"
                                            name="{{$element->order}}"> {{$element->order}}</td>
                                        <td id="title_{{$element->id}}"
                                            name="{{$element->title}}">{{$element->title}}</td>

                                        <td id="page_{{$element->id}}"
                                            name="{{$element->page}}">{{$element->page}}</td>
                                        <td id="pic_{{$element->id}}" name="{{$element->pic}}"><img
                                                src="{{$element->pic}}" style="width: 60px;"/></td>
                                        <td id="link_{{$element->id}}"
                                            name="{{$element->link}}"><a target="_blank" href="{{$element->link}}">لینک</a></td>

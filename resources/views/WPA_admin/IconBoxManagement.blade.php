                ...
                <div class="card text-left">
                    <div class="card-header text-right bg-transparent">
                        <button id="addobject" type="button" data-toggle="modal" data-target=".bd-example-modal-lg"
                            class="btn btn-primary btn-md m-1"> آیکون باکس اضافه کنید
                        </button>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">نام باکس</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" id="BoxName" name="BoxName"
                                                        required placeholder="نوشته بالای باکس">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" id="modal_link" name="link"
                                    ...
                                    @foreach ($elements as $element)
                                        <tr id="tr_{{ $element->id }}">
                                            ...
                                            <td id="order_{{ $element->id }}" name="{{ $element->order }}">
                                                {{ $element->order }}</td>
                                            @php
                                                $TitleArr = json_decode($element->title);
                                            @endphp
                                            <td id="title_{{ $element->id }}" name="{{ $TitleArr->title }}">
                                                {{ $TitleArr->title }}</td>

                                            <td id="BoxName_{{ $element->id }}" name="{{ $TitleArr->BoxName }}">
                                                {{ $TitleArr->BoxName }}</td>

                ...
                <div class="card text-left">
                    <div class="card-header text-right bg-transparent">
                        <button id="addobject" type="button" data-toggle="modal" data-target=".bd-example-modal-lg"
                            class="btn btn-primary btn-md m-1"> ایکون ۳ تایی اضافه کنید
                        </button>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="display: flex;">
                                                            ...
                                                            <input id="modal_pic_1" class="form-control" type="text"
                                                                required name="pic1" value="">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_link_1"
                                                                name="link1" required value="#" placeholder="آدرس">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_text_1"
                                                                name="text1" required value="" placeholder="متن">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_color_1"
                                                                name="color1" required value="" placeholder="رنگ">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="display: flex;">
                                                            ...
                                                            <input id="modal_pic_2" class="form-control" type="text"
                                                                required name="pic2" value="">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_link_2"
                                                                name="link2" required value="#" placeholder="آدرس">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_text_2"
                                                                name="text2" required value="" placeholder="متن">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_color_2"
                                                                name="color2" required value="" placeholder="رنگ">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td style="display: flex;">
                                                            ...
                                                            <input id="modal_pic_3" class="form-control" type="text"
                                                                required name="pic3" value="">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_link_3"
                                                                name="link3" required value="#" placeholder="آدرس">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_text_3"
                                                                name="text3" required value="" placeholder="متن">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" id="modal_color_3"
                                                                name="color3" required value="" placeholder="رنگ">
                                                        </td>
                                                    </tr>
                                    ...
                                    @foreach ($elements as $element)
                                        <tr id="tr_{{ $element->id }}">
                                            ...
                                            <td id="pic_{{ $element->id }}" name="{{ $element->pic }}">مجموعه ۴ تایی
                                                ...
                                                <input class="nested" id="link1_{{ $element->id }}"
                                                    value="{{ $Pics->link1 }}">
                                                <input class="nested" id="txt1_{{ $element->id }}"
                                                    value="{{ $Pics->txt1 }}">
                                                <input class="nested" id="color1_{{ $element->id }}"
                                                    value="{{ $Pics->color1 }}">
                                                <input class="nested" id="Pic2_{{ $element->id }}"
                                                    value="{{ $Pics->pic2 }}">
                                                <input class="nested" id="link2_{{ $element->id }}"
                                                    value="{{ $Pics->link2 }}">
                                                <input class="nested" id="txt2_{{ $element->id }}"
                                                    value="{{ $Pics->txt2 }}">
                                                <input class="nested" id="color2_{{ $element->id }}"
                                                    value="{{ $Pics->color2 }}">
                                                <input class="nested" id="Pic3_{{ $element->id }}"
                                                    value="{{ $Pics->pic3 }}">
                                                <input class="nested" id="link3_{{ $element->id }}"
                                                    value="{{ $Pics->link3 }}">
                                                <input class="nested" id="txt3_{{ $element->id }}"
                                                    value="{{ $Pics->txt3 }}">
                                                <input class="nested" id="color3_{{ $element->id }}"
                                                    value="{{ $Pics->color3 }}">
                                            </td>
                                        ...
                                        @else
                                            name="{{ $element->status }}"> غیر فعال </td> @endif
                                                <td>
                                                <button onclick="LoadModal({{ $element->id }})"
                                                    id="{{ $element->id }}" type="button" data-toggle="modal"
...
@section('page-js')
    <script>
        function LoadModal($selectID) {
            ...
            $('#modal_text_1').val($('#txt1_' + $selectID).val());
            $('#modal_color_1').val($('#color1_' + $selectID).val());
            $('#modal_pic_2').val($('#Pic2_' + $selectID).val());
            $('#modal_link_2').val($('#link2_' + $selectID).val());
            $('#modal_text_2').val($('#txt2_' + $selectID).val());
            $('#modal_color_2').val($('#color2_' + $selectID).val());
            $('#modal_pic_3').val($('#Pic3_' + $selectID).val());
            $('#modal_link_3').val($('#link3_' + $selectID).val());
            $('#modal_text_3').val($('#txt3_' + $selectID).val());
            $('#modal_color_3').val($('#color3_' + $selectID).val());

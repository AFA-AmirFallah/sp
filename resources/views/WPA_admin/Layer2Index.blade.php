                ...
                <div class="card text-left">
                    <div class="card-header text-right bg-transparent">
                        <button id="addobject" type="button" data-toggle="modal" data-target=".bd-example-modal-lg"
                            class="btn btn-primary btn-md m-1"> دسته بندی اضافه کنید
                        </button>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form method="post">
                                            ...
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">کد جیسون شاخص</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" id="modal_link" name="link"
                                                        required value="" placeholder="جیسون شاخص ">
                                                </div>
                                            </div>
                                            ...
                                            <small class="red">در صورتی که میخواهید دسته بندی داخل باکس نباشد به جای تصویر #  را اضافه کنید!</small>
                                            <div class="form-group row">
                                                <div class="col-sm-10">

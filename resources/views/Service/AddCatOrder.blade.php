                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header gradient-purple-indigo 0-hidden pb-80">
                                <h5 class="text-white"><i class=" header-icon i-Aim"></i> افزودن نوع درخواست
                                </h5>
                            </div>
                            <!--begin::form-->
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail1" class="ul-form__label">تصویر درخواست</label>
                                        <div class="input-group">
                                            ...
                                            <input id="modal_pic" class="form-control" type="text" name="pic"
                                                onchange="imagesetter()" value="">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputEmail1" class="ul-form__label">{{ __('image preview') }}</label>
                                        </span>
                                        <img style="max-height: 100px" id="imagepreviw" src="">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <label for="inputEmail1" class="ul-form__label">نام درخواست

                                        </label>
                                        <input type="text" class="form-control" required name="RespnsTypeName"
                                            placeholder="نام درخواست" value="">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="MainDescription"
                                            placeholder="توضیح کوتاه درخواست" value="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <button type="submit" class="btn btn-danger m-1" name="submit"
                                                    value="AddService">افزودن درخواست
                                                </button>
                                            </div>
                                        </div>
                                    </div>

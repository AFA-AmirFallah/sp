...
@section('MainCountent')
    ...
    <div class="nested page page-homepage light" id="cats">
        <div class="navbar navbar-style-1">
            <div class="navbar-inner">
                <div class="left">
                    <a href="#" class="link back" onclick="backtomain()">
    ...
    <div class="page page-homepage light" id="main">
        ...
        <div class="toolbar tabbar tabbar-labels toolbar-bottom menubar-area">
            <div class="toolbar-inner">
                ...
                <a href="{{route('wpaclassification')}}" class="tab-link " onclick="showcats()">
...
@section('page-js')
    <script>
        function showcats() {
            ...
            $("#cats").removeClass('nested');
        }

        function backtomain() {
            $("#main").removeClass('nested');
            $("#cats").addClass('nested');

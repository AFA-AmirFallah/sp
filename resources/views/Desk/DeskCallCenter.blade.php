...
@section('MainCountent')
                    ...
                    <div class="card card-icon mb-4">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="btnaria-header" style="display: flex">
                                ...
                                <button type="button"  onclick="ُShowTicket()" class="btn btn-primary btn-block m-1 mb-3">فهرست <i
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            ...
            <div id="table-continer" class="nested targetForm ">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div id="formloader1" class=" targetForm nested">
    ...
    <div id="ShowTicket" class="row targetForm nested">
        <div class="col-lg-12 mb-12">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title"> فهرست تیکت ها</h3>
                </div>
                <form method="post">
                    @csrf
                    <div class="card-body">
...
@section('bottom-js')
    <script>
            ...
            $.post('', {
                ...
                function(data, status) {
                    ...
                    $.each(data, function(index, value) {
                        ...
                        ProjectSrc = JSON.parse(value.meta_value);
                        $('#MainTable_body').append(`<tr><th scope="row">` + i.toString() + `</th>
                                    <td>` + value.id + `</td>
                                    <td>` + ProjectSrc.subject + `</td>
                                    <td>` + Mdate + `</td>
                                    <td><a href="#" onclick="loadproject(` + value.id + `)" >
                                            بارگذاری پروژه
                                        </a></td>
        ...
        function get_my_project(projectID) {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
